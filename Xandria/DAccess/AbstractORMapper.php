<?php
//extends
require_once( 'Xandria/DAccess/AbstractMapper.php' );

//uses
require_once( 'Xandria/Uqims/Models/ObjectWatcher.php' );


//uses
require_once( 'Xandria/Db/SQLQuery/LimitClause.php' );

//lazy creates
require_once( 'Xandria/Db/TblDescArrayChecker.php' );
...
*/
abstract class Xandria_DAccess_AbstractORMapper extends Xandria_DAccess_AbstractMapper
	{
	...
	protected function getNextAutoIncrementIdByExecutingINSERTQuery( $queryStr )
		...
		try 	{
			...
			if (!( $lastInsertId ))
				...
				throw new Xandria_Db_SQLException( $message );
				}
