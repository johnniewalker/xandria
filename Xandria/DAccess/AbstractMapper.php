...
require_once( 'Xandria/DAccess/ICollectionElementCreator.php' );

/**
*@desc layer super type for all mappers  ( OR and OU )
*/

abstract class Xandria_DAccess_AbstractMapper implements Xandria_DAccess_ICollectionElementCreator
	{
	...
	*/
	protected function getDomainObjectFromObjectWatcher( Xandria_Uqims_Models_UIIdKey $idObj )
		{
		$objectWatcher = Xandria_Uqims_Models_ObjectWatcher::getInstance();
